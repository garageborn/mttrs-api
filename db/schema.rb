...
ActiveRecord::Schema.define(version: 57) do
  ...
  create_table 'accesses', id: :serial, force: :cascade do |t|
    ...
    t.index %w[accessable_type accessable_id date], name: 'index_access_on_assetable_and_created_at', unique: true
  ...
  create_table 'attribute_matchers', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[publisher_id name], name: 'index_attribute_matchers_on_publisher_id_and_name'
  end
  ...
  create_table 'blocked_story_links', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[link_id story_id], name: 'index_blocked_story_links_on_link_id_and_story_id', unique: true
    t.index %w[story_id link_id], name: 'index_blocked_story_links_on_story_id_and_link_id', unique: true
  end
  ...
  create_table 'category_links', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[category_id link_id], name: 'index_category_links_on_category_id_and_link_id', unique: true
    t.index %w[link_id category_id], name: 'index_category_links_on_link_id_and_category_id', unique: true
  ...
  create_table 'category_matchers', id: :serial, force: :cascade do |t|
    ...
    t.integer 'order', default: 0, null: false
    t.index %w[category_id publisher_id], name: 'index_category_matchers_on_category_id_and_publisher_id'
    t.index %w[publisher_id category_id], name: 'index_category_matchers_on_publisher_id_and_category_id'
    t.index %w[publisher_id order], name: 'index_category_matchers_on_publisher_id_and_order'
  end
  ...
  create_table 'link_tags', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[link_id tag_id], name: 'index_link_tags_on_link_id_and_tag_id', unique: true
    t.index %w[tag_id link_id], name: 'index_link_tags_on_tag_id_and_link_id', unique: true
  end
  ...
  create_table 'link_urls', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[link_id url], name: 'index_link_urls_on_link_id_and_url', unique: true
  ...
  create_table 'notifications', id: :serial, force: :cascade do |t|
    ...
    t.index %w[notificable_id notificable_type], name: 'index_notifications_on_notificable_id_and_notificable_type'
    t.index %w[notificable_type notificable_id], name: 'index_notifications_on_notificable_type_and_notificable_id'
  end
  ...
  create_table 'social_counters', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[link_id total], name: 'index_social_counters_on_link_id_and_total'
  ...
  create_table 'story_links', id: :serial, force: :cascade do |t|
    ...
    t.index %w[link_id story_id], name: 'index_story_links_on_link_id_and_story_id', unique: true
    t.index %w[main story_id], name: 'index_story_links_on_main_and_story_id'
    t.index %w[story_id link_id], name: 'index_story_links_on_story_id_and_link_id', unique: true
  end
  ...
  create_table 'tags', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[category_id order], name: 'index_tags_on_category_id_and_order'
