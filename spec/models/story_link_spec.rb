...
RSpec.describe StoryLink do
  ...
  it { should have_db_column(:fixed).with_options(null: false, default: false) }
  it { should have_db_index(%i[link_id story_id]).unique(true) }
  it { should have_db_index(%i[main story_id]) }
